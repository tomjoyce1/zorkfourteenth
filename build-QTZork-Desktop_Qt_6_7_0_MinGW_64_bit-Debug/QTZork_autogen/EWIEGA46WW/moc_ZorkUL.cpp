...
struct qt_meta_stringdata_CLASSZorkULENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSZorkULENDCLASS = QtMocHelpers::stringData(
    "ZorkUL",
    "roomChanged",
    "",
    "std::string",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSZorkULENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ZorkUL::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSZorkULENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSZorkULENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSZorkULENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ZorkUL::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSZorkULENDCLASS.stringdata0))
...
// SIGNAL 0
void ZorkUL::roomChanged(const std::string & _t1)
{
